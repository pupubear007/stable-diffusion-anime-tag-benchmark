...
def txt2img_nai3(p: dict) -> list[bytes]:
    ...
    if p.pop('sampler_index') == 'DPM++ 2M Karras':
        参数['sampler'] = 'k_dpmpp_2m'
        参数['noise_schedule'] = 'karras'
    else:
        raise Exception('我不知道！')
...
模型数据 = [
    ('anythingV3_fp16', 'anything-v4.0.vae.pt', 'A3', False),
    ('anything-v4.5-pruned-fp32', 'anything-v4.0.vae.pt', 'A4.5', False),
    ('AOM3A1', 'orangemix.vae.pt', 'AOM3A1', False),
    ('AOM3A2', 'orangemix.vae.pt', 'AOM3A2', False),
    ('aoaokoPVCStyleModel_pvcAOAOKO', 'novelailatest-pruned.vae.pt', 'APVC', False),
    ('Aidv210AnimeIllustDiffusion_aidv28', 'vae-ft-mse-840000-ema-pruned.ckpt', 'AID28', False),
    ('Aidv210AnimeIllustDiffusion_aidv210', 'vae-ft-mse-840000-ema-pruned.ckpt', 'AID210', False),
    ('calicomix_v75', None, 'CCM75', False),
    ('cosplaymix_v20', None, 'CPM20', False),
    ('counterfeitV30_20', 'Counterfeit-V2.5.vae.pt', 'CF2.0', False),
    ('Counterfeit-V2.2', 'Counterfeit-V2.5.vae.pt', 'CF2.2', False),
    ('Counterfeit-V2.5_pruned', 'Counterfeit-V2.5.vae.pt', 'CF2.5', False),
    ('novelailatest-pruned', 'novelailatest-pruned.vae.pt', 'novelai', False),
    ('darkSushiMixMix_225D', 'vae-ft-mse-840000-ema-pruned.ckpt', 'DS225', False),
    ('etherBluMix_etherBluMix5', 'kl-f8-anime2.ckpt', 'EB5', False),
    ('bluePencil_v9', 'clearvae_v23.safetensors', 'BP9', False),
    ('bluePencil_v10', 'clearvae_v23.safetensors', 'BP10', False),
    ('Counterfeit-V3.0_fp16', 'kl-f8-anime2.ckpt', 'CF3.0', False),
    ('AnythingV5Ink_ink', None, 'A5Ink', False),
    ('sweetfruit_melon.safetensors_v1.0', 'vae-ft-mse-840000-ema-pruned.ckpt', 'SF1.0', False),
    ('cuteyukimixAdorable_midchapter', 'anything-v4.0.vae.pt', 'CYM', False),
    ('cuteyukimixAdorable_midchapter2', 'anything-v4.0.vae.pt', 'CYM2', False),
    ('cuteyukimixAdorable_midchapter3', 'anything-v4.0.vae.pt', 'CYM3', False),
    ('cuteyukimixAdorable_neochapter', 'anything-v4.0.vae.pt', 'CYN', False),
    ('cuteyukimixAdorable_neochapter2', 'anything-v4.0.vae.pt', 'CYN2', False),
    ('cuteyukimixAdorable_neochapter3', 'anything-v4.0.vae.pt', 'CYN3', False),
    ('cuteyukimixAdorable_specialchapter', 'anything-v4.0.vae.pt', 'CYS', False),
    ('cuteyukimixAdorable_naiV3style', 'anything-v4.0.vae.pt', 'CYnai3', False),
    ('cuteyukimixAdorable_kemiao', 'anything-v4.0.vae.pt', 'CYKM', False),
    ('cuteyukimixAdorable_kemiaomiao', 'anything-v4.0.vae.pt', 'CYKMM', False),
    ('cuteyukimixAdorable_echodimension', 'anything-v4.0.vae.pt', 'CYE', False),
    ('cocotifacute_v20', 'novelailatest-pruned.vae.pt', 'CC20', False),
    ('pastelMixStylizedAnime_pastelMixPrunedFP16', 'kl-f8-anime2.ckpt', 'PM', False),
    ('perfectWorld_v2Baked', None, 'PW2', False),
    ('perfectWorld_v6Baked', None, 'PW6', False),
    ('himawarimix_v100', None, 'HW100', False),
    ('meinamix_meinaV11', None, 'MM11', False),
    ('mixProV4_v4', 'novelailatest-pruned.vae.pt', 'MP4', False),
    ('cetusMix_cetusVersion3', 'kl-f8-anime2.ckpt', 'CM3', False),
    ('cetusMix_Coda2', 'kl-f8-anime2.ckpt', 'CMC2', False),
    ('cetusMix_Whalefall2', 'kl-f8-anime2.ckpt', 'CMWF2', False),
    ('cetusMix_v4', 'kl-f8-anime2.ckpt', 'CM4', False),
    ('cetusMix_cetusVersion2', 'kl-f8-anime2.ckpt', 'CM2', False),
    ('sakuramochimix_v10', 'novelailatest-pruned.vae.pt', 'SMM10', False),
    ('sweetMix_v22Flat', 'blessed2.vae.safetensors', 'SM22F', False),
    ('ghostmix_v20Bakedvae', None, 'GM20', False),
    ('anyloraCheckpoint_novaeFp16', 'kl-f8-anime2.ckpt', 'AL', False),
    ('PVCStyleModelMovable_v20NoVae', 'vae-ft-mse-840000-ema-pruned.ckpt', 'PVC20', False),
    ('PVCStyleModelMovable_v30', 'vae-ft-mse-840000-ema-pruned.ckpt', 'PVC30', False),
    ('divineelegancemix_V9', 'MoistMix.vae.pt', 'DLM9', False),
    ('rainbowsweets_v20', None, 'RS20', False),
    ('rabbit_v7', 'novelailatest-pruned.vae.pt', 'R7', False),
    ('rimochan_random_mix', 'blessed2.vae.safetensors', 'RRM', False),
    ('rimochan_random_mix_1.1', 'blessed2.vae.safetensors', 'RRM1.1', False),
    ('rimochan_random_mix_2.1', 'blessed2.vae.safetensors', 'RRM2.1', False),
    ('rimochan_random_mix_3.2', 'blessed2.vae.safetensors', 'RRM3.2', False),
    ('rimochan_random_mix_4.0', 'blessed2.vae.safetensors', 'RRM4.0', False),
    ('rimochan_random_mix_4.1', 'blessed2.vae.safetensors', 'RRM4.1', False),
    ('koji_v21', 'clearvae_v23.safetensors', 'KJ21', False),
    ('kaywaii_v50', 'clearvae_v23.safetensors', 'KW50', False),
    ('kaywaii_v60', 'clearvae_v23.safetensors', 'KW60', False),
    ('kaywaii_v70', 'clearvae_v23.safetensors', 'KW70', False),
    ('kaywaii_v80', 'clearvae_v23.safetensors', 'KW80', False),
    ('kaywaii_v85', 'clearvae_v23.safetensors', 'KW85', False),
    ('kaywaii_v90', 'clearvae_v23.safetensors', 'KW90', False),
    ('jitq_v20', 'blessed2.vae.safetensors', 'JQ20', False),
    ('jitq_v30', 'blessed2.vae.safetensors', 'JQ30', False),
    ('petitcutie_v15', 'blessed2.vae.safetensors', 'PC15', False),
    ('petitcutie_v20', 'blessed2.vae.safetensors', 'PC20', False),
    ('superInvincibleAnd_v2', 'blessed2.vae.safetensors', 'SIA2', False),
    ('ApricotEyes_v10', 'blessed2.vae.safetensors', 'AE10', False),
    ('Yorunohitsuji-v1.0', 'novelailatest-pruned.vae.pt', 'YH', False),
    ('aiceKawaice_channel', 'blessed2.vae.safetensors', 'AKC', False),
    ('coharumix_v6', 'blessed2.vae.safetensors', 'CHM6', False),
    ('irismix_v90', None, 'I90', False),
    ('yetanotheranimemodel_v20', 'blessed2.vae.safetensors', 'YAA20', False),
    ('theWondermix_v12', 'blessed2.vae.safetensors', 'TWM12', False),
    ('animeIllustDiffusion_v052', 'sdxl_vae.safetensors', 'AIDXL52', True),
    ('animeIllustDiffusion_v061', 'sdxl_vae.safetensors', 'AIDXL61', True),
    ('CounterfeitXL-V1.0', None, 'CFXL1.0', True),
    ('counterfeitxl_v20', None, 'CFXL2.0', True),
    ('counterfeitxl_v25', None, 'CFXL2.5', True),
    ('hassakuXLSfwNsfwBeta_betaV01', None, 'HXLB01', True),
    ('reproductionSDXL_2v12', None, 'RXL2v12', True),
    ('kohakuXLBeta_beta7', 'sdxl_vae.safetensors', 'KXLB7', True),
    ('kohakuXLEpsilon_rev1', 'sdxl_vae.safetensors', 'KXLE1', True),
    ('blue_pencil-XL-v0.3.1', None, 'BPXL0.3.1', True),
    ('animagineXLV3_v30', None, 'AMXL30', True),
    ('cutecore_xl', None, 'CCXL', True),
    ('aingdiffusionXL_v06', None, 'ADXL06', True),
